...
#define STRING_CONFIG_H_AUTHOR "(Sander, Mini Kossel" // Who made the changes.
...
//#define MACHINE_UUID "96ebf1e5-af83-4d54-be0d-6366ee5cef43"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
// M301 P14.80 I1.12 D48.75
  #define  DEFAULT_Kp 14.8
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define PID_BED_INTEGRAL_DRIVE_MAX MAX_BED_POWER //limit for the integral term
	...
	//M304 P472.89 I81.08 D689.53
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define  DEFAULT_bedKp 472.89
  #define  DEFAULT_bedKi 81.08
  #define  DEFAULT_bedKd 689.53
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 236.75 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 159.8 // mm

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 22.56 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 33.5 // mm
...
#define Z_MAX_POS (MANUAL_Z_HOME_POS + 1.0)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 224.9//223.9 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 150.5}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 100}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {6000,6000,6000,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define DEFAULT_ZJERK                 DEFAULT_XYJERK    // (mm/sec) Must be same as XY for delta
